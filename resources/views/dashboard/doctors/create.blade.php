...
<div class="py-4">
    <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
        <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
            ...
            <li class="breadcrumb-item active" aria-current="page">@lang('lang.add') @lang('lang.doctors')</li>
        </ol>
    </nav>
    <div class="d-flex justify-content-between w-100 flex-wrap">
        <div class="mb-3 mb-lg-0">
            <h1 class="h4">@lang('lang.add') @lang('lang.doctors')</h1>
        </div>
        <div>
                    ...
                    <div class="row mb-4">
                        <div class="col-lg-12 col-sm-12">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control" id="name" placeholder="@lang('lang.enter') @lang('lang.doctors') "  aria-describedby="" name="name">
                        ...
                        <div class="col-lg-12 col-sm-12">
                            <!-- input -->
                            <div class="mb-4">
                                <label for="">@lang('lang.roles') </label>
                                <select name="role" class="form-select" id="role">
                                    <option value="Rt">@lang('lang.rt')</option>
                                    <option value="Nt">@lang('lang.ms')</option>
                                </select>
                            </div>
                            <!-- End of input -->
                        </div>
