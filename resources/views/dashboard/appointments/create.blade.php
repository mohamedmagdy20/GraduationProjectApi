...
<div class="py-4">
    <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
        <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
            ...
            <li class="breadcrumb-item active" aria-current="page">@lang('lang.add') @lang('lang.appointment')</li>
        </ol>
    </nav>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-lg-6 col-sm-12">
                            ...
                            <div class="mb-4">
                               ...
                               <input type="date"  name="register_date" class="form-control" onchange="getAvailableTime()"  id="register_date">
