...
<div class="py-4">
    <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
        <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
            ...
            <li class="breadcrumb-item active" aria-current="page">@lang('lang.edit') @lang('lang.admins')</li>
        </ol>
    </nav>
    <div class="d-flex justify-content-between w-100 flex-wrap">
        <div class="mb-3 mb-lg-0">
            <h1 class="h4">@lang('lang.edit') @lang('lang.admins')</h1>
        </div>
        {{-- <div>
                    ...
                    <div class="row mb-4">
                        <div class="col-lg-6 col-sm-12">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control" id="name" name="name" value="{{$data->name}}" placeholder="@lang('lang.enter') @lang('lang.name')">
