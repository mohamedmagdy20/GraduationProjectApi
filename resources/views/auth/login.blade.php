...
<!-- Primary Meta Tags -->
<title>Brain Tummer Dashboard</title>
...
<!-- Smooth scroll -->
<script src="{{asset('assets/lib/smooth-scroll/dist/smooth-scroll.polyfills.min.js')}}"></script>

<!-- Charts -->
<script src="{{asset('assets/lib/chartist/dist/chartist.min.js')}}"></script>
<script src="{{asset('assets/lib/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.css')}}"></script>
